...
// Normalize newlines in both content and search target just in case
const normalize = str => str.replace(/\r\n/g, '\n').trim();

if (!normalize(content).includes(normalize(targetRender))) {
  console.error("Could not find targetRender in file!");
  process.exit(1);
}
